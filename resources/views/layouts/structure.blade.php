    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar">
            ...
            <div class="left-custom-menu-adp-wrap">
                ...
                <?php $unSeenMsgs = \App\models\Notification::whereSeen(false)->count(); ?>

                @if($unSeenMsgs > 0)
                    <a href="{{route('notifications')}}" target="_blank" style="color: red; font-size: 18px; font-weight: bolder; margin-right: 20px; margin-top: 20px; cursor: pointer">{{$unSeenMsgs}} پیام جدید</a>
                @endif
...
{{--                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-envelope"></i> <span onclick="document.location.href = '{{url('complaints')}}'" class="mini-dn">شکایات</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a></li>--}}
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-table"></i> <span class="mini-dn">گزارش گیری</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
